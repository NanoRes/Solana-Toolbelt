...
public static class WebGLTemplatesExporter {
    ...
    private static void OnScriptsReloaded() {
        ...
        var sourceRootFolder = Path.GetFullPath("Assets/Solana/Runtime/codebase/WebGLTemplates/");
        ...
        {
            Debug.LogWarning($"[WebGLTemplatesExporter] Source folder not found at {sourceRootFolder}. Skipping export.");
            return;
        }
        ...
        foreach (var templateFolder in Directory.GetDirectories(sourceRootFolder))
        {
