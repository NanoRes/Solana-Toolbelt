...
namespace Solana.Unity.SDK.Exporters
{
    public class PrefabsExporter
    {
        ...
        private static void OnScriptsReloaded()
        {
            ...
            var sourceRootFolder = Path.GetFullPath("Assets/Solana/Runtime/codebase/Prefabs/");
            ...
            {
                Debug.LogWarning($"[PrefabsExporter] Source folder not found at {sourceRootFolder}. Skipping export.");
                return;
            }
