        ...
        var transaction = new TransactionBuilder()
            ...
            .AddInstruction(
                TokenProgram.MintTo(
                    ...
                    1,
                    Web3.Account))
            .AddInstruction(Solana.Unity.Metaplex.NFT.Library.MetadataProgram.CreateMetadataAccount(
            ...
            .AddInstruction(Solana.Unity.Metaplex.NFT.Library.MetadataProgram.CreateMasterEdition(
                    maxSupply: null,
